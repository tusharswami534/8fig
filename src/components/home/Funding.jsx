    ...
    <div  className='px-5'>
        <div className='max-w-[1166px] mx-auto max-lg:flex-col max-lg:gap-11 flex justify-between py-12'>
            <div className='flex flex-col max-lg:items-center justify-center'>
                <div className='max-w-[401px] max-lg:text-center max-lg:mx-auto'>
                <CommonHeading Headings={'Become an 8 figure seller with AI funding'}/>
                </div>
                <button className='py-2.5 flex max-w-[173px] whitespace-nowrap px-11 mt-[30px] bg-[#4C57FF] text-white font-poppins font-medium leading-[150%] rounded-3xl hover:bg-white hover:text-[#4C57FF] border border-solid border-[#4C57FF] transition-all duration-300'>
                Apply now
                </button>
            </div>
            <div>
